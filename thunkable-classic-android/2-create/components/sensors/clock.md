---
description: >-
  The Clock component uses the internal clock on a phone to both set a Timer (to
  trigger an event) or to get the current time in a variety of date and time
  formats
---

# Clock

### ![](https://thunkable.gitbooks.io/thunkable-docs/content/assets/clock-icon.png) {#thunkable-for-android-❤}
