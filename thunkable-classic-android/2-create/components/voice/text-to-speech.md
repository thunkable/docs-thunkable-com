---
description: >-
  The Text to Speech component speaks a given text aloud. You can set the pitch
  and the rate of speech because the speech is synthesized from human speech.
---
