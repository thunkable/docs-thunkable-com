---
description: >-
  To reach a larger audience for your app, consider publishing it to the Google
  Play store
---
...
* [Set up](4-publish.md#1--set-up)
* [Version your app](4-publish.md#2--version-your-app)
* [Download app \(.apk\) to your computer](4-publish.md#exporting-your-keystore-from-mit-app-inventor)
* [Upload to Google Play](4-publish.md#4--publish-your-app)
* [Package name](4-publish.md#5--package-name)
* [Keystores](4-publish.md#6--keystores)
