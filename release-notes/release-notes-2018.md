...
* Each new project can be set to [public or private](../projects.md).  Public projects are eligible to be featured in the Thunkable Gallery and can be shared in both [read-only](../share-1.md#share-a-read-only-version-of-your-app-project) and fully-editable mode
