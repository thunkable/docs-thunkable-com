...
* All iOS apps built with Thunkable now compatible with iOS 15
* Improved build times for iOS apps

## September 17, 2021

Component Updates

* DND: Added new font options to [Label](https://docs.thunkable.com/v/drag-and-drop/label) and [Button](https://docs.thunkable.com/v/drag-and-drop/button)
