...
* [Set a Version Number](./#set-a-version-number)
* [Review Your App Permissions](./#review-your-app-permissions)
* [Create an Apple Developer Account](./#create-an-apple-developer-account)
* [Create an App-Specific Password](./#create-an-app-specific-password)
* [Register an App ID on App Store Connect](./#register-an-app-id-on-app-store-connect)
* [Create an App Listing on App Store Connect](./#create-an-app-listing-on-app-store-connect)
...
* [Start the Publishing Process in Thunkable](./#start-the-publishing-process-in-thunkable)
* [Enter your Apple Developer Account Details](./#enter-your-apple-developer-account-details)
* [Register Your App ID](./#register-your-app-id)
* [Enter your App Name, Team ID and Bundle ID](./#enter-your-app-name-team-id-and-bundle-id)
* [Create a Distribution Certificate](./#create-a-distribution-certificate)
* [Provision your App](./#provision-your-app)
* [Enter your App-Specific Password](./#enter-your-app-specific-password)
* [Create an App Listing on App Store Connect](./#create-an-app-listing-on-app-store-connect-1)
* [Upload an Icon and enter your Build Number and Version Number](./#upload-an-icon-and-enter-your-build-number-and-version-number)
...
* [Connect Your Build to your App Listing](./#connect-your-build-to-your-app-listing)
