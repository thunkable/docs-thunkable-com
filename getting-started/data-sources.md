...
1. Add a Data Viewer (list or grid) to your project. More on Data Viewers is available here: [data-viewers](../app-design/ui-components/data-components/data-viewers/ "mention"), OR
...
`Get row object` will return the row object of the specified row ID. The row object can be used with [Objects blocks.](../blocks/blocks/objects.md)
