...
![](.gitbook/assets/package\_name.png)
...
![](.gitbook/assets/build\_name.png)

## Download your Android app

![](.gitbook/assets/download\_android.png)
...
To export a keystore from a Thunkable project, Click the name and icon of your app in upper left corner to bring up App Settings on right side as seen in 'Import keystore to Thunkable'. Scroll all the way to the bottom of the App Settings and click Export Keystore.&#x20;
