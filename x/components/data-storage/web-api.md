...
The blocks above retrieves data from the [Weather Underground API](https://www.wunderground.com/weather/api/d/docs?MR=1) and filters it using our new [Object](/x/blocks/objects.md) blocks.  The original response data is in the JSON format below:
