---
description: >-
  The Animation component powered by Lottie makes adding animations as easy as
  adding images
---

# Lottie

The Animation component powered by [Lottie ](https://airbnb.design/lottie/)makes adding animations as easy as adding images. For designers, animations can be created in [Adobe After Effects](https://www.adobe.com/products/aftereffects.html) and imported as a `.json` file.
