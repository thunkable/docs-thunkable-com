---
description: >-
  The Map component is powered by the most popular mapping services, Google Maps
  for both Android and iOS and Apple Maps for iOS
---
...
* [Style the Map](map.md#style-the-map-google-maps-only) 
