...
* [Local DB](broken-reference) - create and retrieve data from a data table directly saved in your app

Component updates

* [Share](../../blocks/app-features/share.md) - now enables users to send text messages, emails and make phone calls from mobile's device's default apps

New block category

* [Device](../../blocks/blocks/device.md)
  * [Date and time](../../blocks/blocks/device.md#get-current-time-and-date) - Get the current time from the device's clock
  * [Vibrate](../../blocks/blocks/device.md#set-device-to-vibrate) - sets a device to vibrate&#x20;
  * [iOS or Android](../../blocks/blocks/device.md#get-mobile-operating-system) - detects which platform the device is on
  * [Online or offline](../../blocks/blocks/device.md#get-online-offline-status) - detects if device is connected to Wi-Fi or data network
...
* [Publish to iOS](../../publishing-apps/publish-to-app-store-ios/) - Supports the ability to publish to iOS with two-factor authentication turned on
...
* Tab Navigator - Supports adding icons to the tab navigator with the introduction of two new components, a [Top Tab Navigator](../../app-design/screens-and-navigators/top-tab-navigator.md) and a [Bottom Tab Navigator](../../app-design/screens-and-navigators/bottom-tab-navigator.md). The original [Tab Navigator](broken-reference) will continue to be supported in existing projects but we highly encourage creators to adopt the new tab components which will have more features
...
* Fixes the compatibility issue with the new [variable](broken-reference), [list](../../blocks/blocks/lists.md) and [object](../../blocks/blocks/objects.md) blocks
...
{% hint style="success" %}
Thunkable has launched the [Public Gallery](broken-reference), a public collection apps for anyone to preview, download or remix.
...
* [Variables](../../blocks/blocks/variables.md) can now be of type 'app', stored' and 'cloud'.  Existing uses of variables will continue to work as they did before this change.
...
* Some app layouts have been updated
  ...
  * [Scrollable columns](broken-reference) - height will need to be set to 'fit contents'

Bug fixes

* Android app no longer crashes when [open link](../../blocks/blocks/control.md#open-an-installed-app-or-website-by-link) block is triggered
...
* [Shuffle list](../../blocks/blocks/lists.md#shuffle-list) - get a copy of a list with the items shuffled in a random order.
...
* [Alert](../../blocks/app-features/alert.md) - launches a dialog / notification with a message and one or more buttons
...
* Each new project can be set to [public or private](../../getting-started/get-started/projects.md).  Public projects are eligible to be featured in the Thunkable Gallery and can be shared in both [read-only](../../settings/manage-your-projects/download-and-share/share-1.md#share-a-read-only-version-of-your-app-project) and fully-editable mode
...
* [Switch](broken-reference) component no longer needs blocks to set-up

## May 22, 2018

Component updates

* [Map](../../app-design/ui-components/embed-components/map.md) - adds new block events e.g. on Map Click, on Marker Click and supports the ability to add markers, polylines and polygons
* [Text to Speech](https://docs.thunkable.com/text-to-speech) - increase supported languages from 6 to 87
* [Share](../../blocks/app-features/share.md#share-an-image) - now supports sharing locally stored assets (does not work on Live Test for iOS)

New components

* [Location Sensor](../../blocks/app-features/sensors-blocks/location-sensor.md) - gets user's current location
* [Slider](../../app-design/ui-components/input-components/slider.md) - UI element of choice for letting users select a value or range from a fixed set of options, such as setting the brightness of a screen
...
* [Share a read-only version](../../settings/manage-your-projects/download-and-share/share-1.md#share-a-read-only-version-of-your-app-project-by-link) of your project is now supported with a public option
...
* Live app now lets you [live preview](../../getting-started/live-test.md#live-preview-android-only) all your app projects from the comfort of your mobile device (Android only)
* [Publish for Android](../../publishing-apps/publish/#publish-to-the-play-store-android) now supported
...
* Updated [download](../../settings/manage-your-projects/download-and-share/download.md#download-and-install-ios-app) and [publish](../../publishing-apps/publish/#publish-to-the-app-store-ios) emails for iOS

## April 12, 2018

Component updates

* [Button](../../app-design/ui-components/basic-components/button.md) - supports a number of new properties including sizing (height, width) and adding a background picture
...
* [Share](../../blocks/app-features/share.md) - allows users to share text or post images using their favorite installed communication app from Slack and Facebook to iMessage and WhatsApp
* [Switch](broken-reference) - popular UI element to turn on and off a certain feature in an app, often used in settings pages
...
* [Spreadsheet](broken-reference) by Airtable - gets, uploads, updates and deletes data from the popular spreadsheet service
...
* [Custom app package name ](broken-reference)/ bundle ID now supported for both Android and iOS; app icon also supported for Android
* [Make a copy ](../../settings/manage-your-projects/make-copy.md)of your project aka checkpoint in one click
* Tracking of project [shares](../../settings/manage-your-projects/download-and-share/share-1.md) now available on project page; share links no longer require a user to be logged in
...
* [Media Database](broken-reference) powered by Cloudinary - support for image, audio and video upload
...
* [Realtime DB](broken-reference) powered by Firebase - changes set-up from adding a .plist file to entering in an API key and database URL into app settings
